...
/* Generated from ../O.Common/SPI_test.dbd */
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devaaiStream,
    ...
    *pvar_dset_devGpioBi, *pvar_dset_devBoSoft, *pvar_dset_devBoSoftRaw,
    ...
    *pvar_dset_devGpioBo, *pvar_dset_devCalcoutSoft,
...
static const char * const deviceSupportNames[] = {
    ...
    "asynBiInt32", "asynBiUInt32Digital", "devbiStream", "devGpioBi",
    "devBoSoft", "devBoSoftRaw", "devBoSoftCallback", "devBoGeneralTime",
    "devBoDbState", "asynBoInt32", "asynBoUInt32Digital", "devboStream",
    "devGpioBo", "devCalcoutSoft", "devCalcoutSoftCallback",
    "devcalcoutStream", "devEventSoft", "devHistogramSoft",
    "devI64inSoft", "devI64inSoftCallback", "asynInt64In",
    "devint64inStream", "devI64outSoft", "devI64outSoftCallback",
    "asynInt64Out", "devint64outStream", "devLiSoft", "devLiSoftCallback",
...
epicsShareExtern reg_func pvar_func_AsynDriverInterfaceRegistrar,
    ...
    pvar_func_devGpioConstRegister, pvar_func_drvAsynSPIRegister,
...
int SPI_test_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/greenbt2/EPICS/IOCs/SPI_test";
    ...
    runRegistrarOnce(pvar_func_devGpioConstRegister);
    runRegistrarOnce(pvar_func_drvAsynSPIRegister);
...
/* SPI_test_registerRecordDeviceDriver */
...
static const iocshFuncDef rrddFuncDef = {
    ...
    "Example: SPI_test_registerRecordDeviceDriver pdbbase\n",
};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(SPI_test_registerRecordDeviceDriver(*iocshPpdbbase));
}
